...
def afficher_attaque(structure, MITM_up, diff, MITM_down, key_space,z=4):
    ...
    if resultat[0] :
        ...
        compteur_bleu, compteur_rouge, compteur_differentielle, compteur_fix, compteur_violet,compteur_statetest_haut, compteur_statetest_bas, compteur_probaup, compteur_probadown = resultat[10], resultat[11], resultat[12], resultat[13], resultat[14], resultat[15], resultat[16], resultat[17], resultat[18]
        Cblue, Cred, Cmatch = resultat[19], resultat[20], resultat[21]
...
def recherche_attaque(mim_round, max_round, complexity):
    ...
    z=8
    for structure_round in range(2,9):
        for MITM_up_round in range(2,12):
            for diff_round in range(2,10):
...
afficher_attaque(2,5,13,5,3,8)# structure size, MITM up size, differential distinguisher size +1, MITM down size -1, key space size, word length 
