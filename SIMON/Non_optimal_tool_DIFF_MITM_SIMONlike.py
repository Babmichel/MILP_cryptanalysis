...
def diff_mitm_SIMON():
    ...
    with gp.Env(params=options) as env, gp.Model(env=env) as model:
        ...
        print('Do you want to generate pdf figure of th attack ?')
        pdf_image = int(input())
        ...
        time_complexity_up = model.addVar(lb = state_size, ub = key_size,vtype= GRB.INTEGER, name = "complexity_up")
        time_complexity_down = model.addVar(lb = state_size, ub = key_size,vtype= GRB.INTEGER, name = "complexity_down")
        time_complexity_match = model.addVar(lb = state_size, ub = key_size,vtype= GRB.INTEGER, name = "complexity_match")
