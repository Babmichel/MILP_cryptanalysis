# The following fonction search for an optimal key recovery path for differential attacks on SIMON
# To run the code you need the library "gurobipy" and a GUROBI licence
...
def diff_mitm_SIMON():
    ...
    with gp.Env(params=options) as env, gp.Model(env=env) as model:
        ...
        #However if the state is bigger than 120 bits we can no more use 2^x + 2^y 2^z, and sub optimize on x + y + z
