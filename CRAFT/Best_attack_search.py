...
for element in Solution :
    ...
    diff_round = Solution[2]
    MITM_down_round = Solution[3]
    complexity = Solution[4]
    print("valid attack on ",structure_round + MITM_up_round+ diff_round+ MITM_down_round, " round, with complexity ", complexity )
